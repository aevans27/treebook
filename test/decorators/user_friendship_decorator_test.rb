...
setup do
@friend = create(:user, first_name: 'Tim') 
end
...
context "with a pending user friendship" do
			...
			should "return the correct message" do
				assert_equal "Do you really want to be friends with Tim?", @decorator.sub_message
			end
		end
	...
	context "with an accepted user friendship" do
		...
		should "return the correct message" do
			assert_equal "You are friends with Tim.", @decorator.sub_message
		end
	end
end
	...
	context "with a pending user friendship" do 
		...
		context "with an accepted user friendhsip" do
			setup do
		...
		context "with an requested user friendhsip" do
			setup do
